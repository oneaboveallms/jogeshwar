...
resource "aws_security_group" "aerospike_sg" {
  vpc_id = aws_vpc.main.id
...
resource "aws_instance" "Aerospike_server" {
  ...
  vpc_security_group_ids = [aws_security_group.aerospike_sg.id]
  key_name      = "osaka"
...
resource "aws_lb" "app_lb" {
  ...
  security_groups    = [aws_security_group.aerospike_sg.id]
...
resource "aws_vpc_peering_connection" "vpc_peering" {
  vpc_id      = aws_vpc.main.id
  peer_vpc_id = "vpc-0cdf17c342293a4fa" # Replace with your Default VPC ID
...
resource "aws_route" "default_to_custom" {
  route_table_id         = "rtb-0809573cc7792b3a2" # Replace with Default VPC Route Table ID
